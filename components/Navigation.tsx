    ...
    <nav className="flex flex-col justify-between p-4 w-64 border-r bg-gray-50 overflow-auto">
      <div>
        ...
        <ul>
          <li>
            <Link href="/">
              <a className="transition py-1 px-2 hover:bg-gray-200 rounded-lg inline-flex mb-1">
                Home
              </a>
            </Link>
          </li>
          <li>
            <Link href="/">
              <a className="transition py-1 px-2 hover:bg-gray-200 rounded-lg inline-flex bg-gray-200">
                Home
              </a>
            </Link>
          </li>
